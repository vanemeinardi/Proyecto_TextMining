...
tabla=pd.read_csv('/home/vmeinardi/Proyecto_NLP/LDA_unigramas.csv')
print(tabla.columns)
...
results_df.to_csv("decision_tree_results_unigramas_LDA.csv", index=False)
...
metrics_df.to_csv("DT_best_parametros_unigramas_LDA.csv")
