...
results_df.to_csv("decision_tree_results_analisis_sentimiento_comunidades.csv", index=False)
...
metrics_df.to_csv("DT_best_parametros_analisis_sentimiento_comunidades.csv")
