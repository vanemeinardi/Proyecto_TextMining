...
tabla=pd.read_csv('/home/vmeinardi/Proyecto_NLP/LDA_caracteristicas.csv')
print(tabla.columns)
...
results_df.to_csv("decision_tree_results_caracteristicas_contextuales_LDA.csv", index=False)
...
metrics_df.to_csv("DT_best_parametros_caracteristicas_contextuales_LDA.csv")
