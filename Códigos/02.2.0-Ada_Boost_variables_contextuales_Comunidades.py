...
param_grid = {
    'classifier__n_estimators': [20, 100, 200, 400],
...
data = {
    'Parámetros': [f"n_estimators={params['classifier__n_estimators']}, "
                   f"learning_rate={params['classifier__learning_rate']}" for params in results['params']],
...
results_df.to_csv("ada_boost_results_caracteristicas_contextuales_comunidades.csv", index=False)
...
metrics_df.to_csv("AB_best_caracteristicas_contextuales_comunidades.csv")
