...
tabla=pd.read_csv('/home/vmeinardi/Proyecto_NLP/LDA_modelos_chi.csv')
print(tabla.columns)
...
results_df.to_csv("decision_tree_results_todas_variables_LDA.csv", index=False)
...
metrics_df.to_csv("DT_best_parametros_todas_variablesDe_LDA.csv")
