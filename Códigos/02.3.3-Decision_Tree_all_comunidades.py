...
tabla=pd.read_csv('/home/vmeinardi/Proyecto_NLP/comunidades_modelos_chi.csv')
print(tabla.columns)

# Separar las características y la variable objetivo
X = tabla.drop(columns=['postura'])
y = tabla['postura']
...
results_df.to_csv("decision_tree_results_todas_variables_comunidades.csv", index=False)
...
metrics_df.to_csv("DT_best_parametros_todas_variables_comunidades.csv")
